package org.geekbrains.JAVA.HW.HW6;
...
public class Main {
    public static void main(String[] args) {
        Laptop laptop1 = new org.geekbrains.JAVA.HW.HW6.Laptop(100000, "1", LocalDateTime.now(), 1, "black", "MAC", 1024, 16);
        Laptop laptop2 = new org.geekbrains.JAVA.HW.HW6.Laptop(65000, "2", LocalDateTime.now(), 2, "white", "Linux", 512, 8);
        Laptop laptop3 = new org.geekbrains.JAVA.HW.HW6.Laptop(75000, "3", LocalDateTime.now(), 3, "yellow", "Windows", 2048, 32);
        Laptop laptop4 = new org.geekbrains.JAVA.HW.HW6.Laptop(68000, "4", LocalDateTime.now(), 3, "white", "Linux", 512, 8);
        Laptop laptop5 = new org.geekbrains.JAVA.HW.HW6.Laptop(85000, "5", LocalDateTime.now(), 2, "yellow", "Windows", 2048, 32);
        Laptop laptop6 = new org.geekbrains.JAVA.HW.HW6.Laptop(95000, "6", LocalDateTime.now(), 1, "black", "MAC", 1024, 16);
